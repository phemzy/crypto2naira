...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="en"> <!--<![endif]-->
    <head>
        ...
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="<?php echo e(URL::to('assets/js/plugins/slick/slick.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::to('assets/js/plugins/slick/slick-theme.min.css')); ?>">
    ...
    <body>
            ...
            <aside id="side-overlay">
                ...
                <div id="side-overlay-scroll">
                    ...
                    <div class="side-header side-content">
                        ...
                        <span>
                            <img class="img-avatar img-avatar32" src="<?php echo e(URL::to('assets/img/avatars/avatar10.jpg')); ?>" alt="">
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="<?php echo e(route('admin.dashboard')); ?>">
                                ADMIN
                            </a>
                        </div>
                        <!-- END Side Header -->
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                <li>
                                    <a class="active" href="<?php echo e(route('admin.dashboard')); ?>"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.all', 'purchase')); ?>">All</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.status', ['type' => 'purchase', 'status' => 'pending'])); ?>">Pending</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.status', ['type' => 'purchase', 'status' => 'matched'])); ?>">Matched</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.status', ['type' => 'purchase', 'status' => 'failed'])); ?>">Failed</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.status', ['type' => 'purchase', 'status' => 'complete'])); ?>">Complete</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                       <li>
                                            <a href="<?php echo e(route('admin.transactions.all', 'sell')); ?>">All</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.status', ['type' => 'sell', 'status' => 'pending'])); ?>">Pending</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.status', ['type' => 'sell', 'status' => 'matched'])); ?>">Matched</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.status', ['type' => 'sell', 'status' => 'failed'])); ?>">Failed</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('admin.transactions.status', ['type' => 'sell', 'status' => 'complete'])); ?>">Complete</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo e(route('matcher')); ?>">New Matcher</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('matcher.multi')); ?>">Multi Matcher</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-lock"></i><span class="sidebar-mini-hide"><?php echo e($p->name); ?> <span class="badge"><?php echo e($p->transactions->count()); ?></span></span></a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo e(route('users.all')); ?>">All Users</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('users.all', 'blocked')); ?>">Blocked Users</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('users.all', 'incomplete')); ?>">Incomplete Profiles</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('users.all', 'inactive')); ?>">Inactive Profiles</a>
                                        </li>
                                    </ul>
                                </li>
        ...
        <!-- Page JS Code -->
        <script src="<?php echo e(URL::to('assets/js/pages/base_pages_dashboard.js')); ?>"></script>
