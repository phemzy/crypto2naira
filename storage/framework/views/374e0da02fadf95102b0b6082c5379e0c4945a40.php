	                ...
	                <div class="block block-themed">
	                    ...
	                    <div class="block-content">
	                        <div class="text-center push-10-t push-30">
	                            <img class="img-avatar img-avatar96" src="<?php echo e($t->recipient() ? ($t->recipient()->profile->profile_pic ? Storage::url($t->recipient()->profile->profile_pic) : asset('assets/img/avatars/avatar10.jpg')) : asset('assets/img/avatars/avatar10.jpg')); ?>" alt="">
	                        </div>
	                        <div class="row">
		                        <div class="col-md-6 col-md-offset-3">
		                        	<form class="form-horizontal push-10" action="<?php echo e(route('payment.confirm', $t->id)); ?>" method="post">
			                            ...
			                            <div class="form-group">
			                                <div class="col-xs-12">
			                                    <div class="form-material">
			                                        <input class="form-control" type="text" disabled="" id="name" name="name" value="<?php echo e($t->recipient() ? 
			                                        	$t->market->abbr_name == 'TBC' ? 
			                                        	$t->recipient()->profile->tbc_wallet_id : $t->recipient()->profile->grc_email : ''); ?>">
			                                        <label for="name"><?php echo e($t->market->abbr_name == 'TBC' ? 'TBC Wallet ID' : 'GRC Email'); ?></label>
			                                    </div>
			                                </div>
			                            </div>
										<?php if($t->recipient()): ?>
											<div class="form-group">
				                                <div class="col-xs-12">
				                                	<?php if($t->matched_transaction->proof_of_payment == NULL): ?>
				                                    	 <p class="btn btn-rounded btn-primary"><?php echo e($t->recipient()->fullname()); ?> has not uploaded proof</p>
				                                    <?php else: ?>
	                    ...
	                    <div class="block-content" style="padding-bottom: 50px;">
	                    	<div class="row text-center">
	                    		...
	                    		<div class="col-xs-4"><a href="<?php echo e(route('market.sell', $t->market->abbr_name)); ?>" class="btn btn-rounded btn-success">Market</a></div>	                    		
	                    	</div>	
	                    </div>
	                </div>
	                <!-- END Material Lock -->
