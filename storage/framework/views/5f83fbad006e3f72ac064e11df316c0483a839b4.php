...
<!--[if gt IE 8]><!--> <html class="no-js" lang="<?php echo e(config('app.locale')); ?>"> <!--<![endif]-->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="header-nav">
                        <nav>
                            ...
                            <ul class="member-actions">
                                ...
                                <li><a href="<?php echo e(route('logout')); ?>" class="btn-white btn-small" onclick="event.preventDefault(); document.getElementById('logout').submit()">Logout</a>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="feature-list">
                        ...
                        <a href="<?php echo e(route('faq')); ?>" class="btn btn-ghost btn-accent btn-small">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="sign-up col-md-12 text-center">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form class="signup-form" action="<?php echo e(route('subscribe')); ?>" method="POST" role="form">
                        <?php echo e(csrf_field()); ?>

                        <div class="form-input-group<?php echo e($errors->first('name') ? ' has-error' : ''); ?>" >
                           <input type="text" class="" placeholder="Enter your name" name="name" required>
                           <?php if($errors->first('name')): ?>
                                <span class="help-block"><?php echo e($errors->first('name')); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="form-input-group<?php echo e($errors->first('email') ? ' has-error' : ''); ?>">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 text-center">
                    ...
                    <a href="<?php echo e(route('faq')); ?>" class="btn btn-fill btn-lg btndanger">Click Here</a>
                </div>
            </div>
        </div>
    </section>
